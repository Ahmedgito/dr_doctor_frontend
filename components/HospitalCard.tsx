    ...
    >
      ...
      <div>
        <div className="flex items-start justify-between mb-3">
            <div className="p-2 bg-teal-500/10 rounded-xl text-teal-400 ring-1 ring-teal-500/20 group-hover:bg-teal-500/20 transition-colors">
                <MapPin size={20} />
            </div>
            <div className="flex items-center gap-1 bg-white/5 border border-white/5 px-2 py-1 rounded-full text-xs font-medium text-slate-300">
                <Star size={10} className="text-yellow-400 fill-yellow-400" />
                <span>4.8</span>
            </div>
        </div>
        
        <h3 className="font-bold text-slate-100 text-lg leading-tight mb-1 line-clamp-2 group-hover:text-teal-300 transition-colors">
            {mapData.title}
        </h3>
      ...
      <a 
        ...
        className="
            ...
            bg-white/5 hover:bg-teal-500 hover:text-white
            border border-white/5 hover:border-teal-500
